...
struct ENCODED_FRAME_DATA {
    ENCODED_FRAME_DATA(){pData = nullptr;NumBytes = 0;AviDwFlags=0;
                         frameNumber=0; Ready=false; bufferSize=0;}
    ~ENCODED_FRAME_DATA(){}//{if(pData!=nullptr) delete pData;}
    char *      pData;
    uint32_t    NumBytes;
    DWORD       AviDwFlags;
...
public:
    ...
    ENCODED_FRAME_DATA                                   m_lastFrame;
...
public:
    ...
    ENCODED_FRAME_DATA *    GetLastFramePtr();
